...
6. I compare the results for `fedavg_dqn` against `fedavg5`. The plots are present in `plot/Results`.
   ...
   4. `fedavg5` Client Eval Accuracies ![](https://github.com/patodiayogesh/fedavgpy_rl/blob/master/plot/Results/mnist_all_data_0_equal_niid_fedavg5_2nn__wn10_tn100_sd42_lr0.1_ep10_bs32_a/Client Eval Accuracies.png)
